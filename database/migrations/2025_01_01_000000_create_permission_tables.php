...
/**
 * Migración estándar del paquete spatie/laravel-permission.
 * Se incluye aquí ya versionada para que el proyecto quede
 * reproducible con `php artisan migrate --seed` sin pasos manuales.
 */
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create($tableNames['roles'], function (Blueprint $table) use ($teams) {
            ...
            $table->string('name');
            $table->string('guard_name');
            $table->string('description')->nullable()->comment('Descripción legible del rol');
            $table->timestamps();
            if ($teams) {
