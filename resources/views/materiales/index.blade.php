...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <div class="d-flex gap-2 flex-wrap">
            <a href="{{ route('materiales.importar.plantilla') }}" class="btn btn-outline-secondary btn-sm">
                <i class="fas fa-file-download me-1"></i>Plantilla Excel
            </a>
            <button class="btn btn-outline-success btn-sm" id="btnImportar">
                <i class="fas fa-file-import me-1"></i>Importar
            </button>
            <a href="{{ route('materiales.exportar.excel') }}" class="btn btn-outline-success btn-sm">
                <i class="fas fa-file-excel me-1"></i>Excel
            </a>
            <a href="{{ route('materiales.exportar.pdf') }}" class="btn btn-outline-danger btn-sm">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="unidad" id="material_unidad" class="form-select">
                                @foreach(['UND','KG','M2','M3','ML','BLS','GAL','LTS'] as $u)
    ...
    var tabla = $('#tablaMateriales').DataTable({
        ...
        columns: [
            { 
                data: 'imagen',
                render: function(img) {
                    var src = img ? '/storage/' + img : '{{ asset('images/material-default.png') }}';
