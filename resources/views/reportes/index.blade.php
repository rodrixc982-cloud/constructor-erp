...
$(document).ready(function() {
    ...
    const rutas = {
        'por-cliente': '{{ route("reportes.por-cliente") }}',
        'por-proyecto': '{{ route("reportes.por-proyecto") }}',
        'por-material': '{{ route("reportes.por-material") }}',
        'utilidad-mensual': '{{ route("reportes.utilidad-mensual") }}',
        'por-estado': '{{ route("reportes.por-estado") }}',
    };
