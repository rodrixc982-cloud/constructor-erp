        ...
        <div class="stat-card">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="number">{{ $totalMateriales ?? 0 }}</div>
                </div>
        ...
        <div class="stat-card green">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="number">{{ $entradasMes ?? 0 }}</div>
                </div>
        ...
        <div class="stat-card red">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="number">{{ $salidasMes ?? 0 }}</div>
                </div>
        ...
        <div class="stat-card orange">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    ...
                    <div class="number">{{ $alertas->count() ?? 0 }}</div>
                </div>
...
@if(isset($alertas) && $alertas->count())
<div class="alert-modern alert alert-warning mb-4 d-flex align-items-center">
    ...
    <div>
        ...
        <span class="fw-bold">{{ $alertas->pluck('nombre')->join(', ') }}</span>
    </div>
</div>
@endif
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-4 col-lg-3">
                        <div class="warehouse-card">
                            ...
                            <h6 class="fw-bold mb-1">{{ $a->nombre }}</h6>
...
$(document).ready(function() {
    ...
    const actions = [
        { id: 'btnEntrada', modal: 'modalEntrada', form: 'formEntrada', route: '{{ route("inventario.entrada") }}' },
        { id: 'btnSalida', modal: 'modalSalida', form: 'formSalida', route: '{{ route("inventario.salida") }}' },
        { id: 'btnTransferencia', modal: 'modalTransferencia', form: 'formTransferencia', route: '{{ route("inventario.transferencia") }}' },
        { id: 'btnAjuste', modal: 'modalAjuste', form: 'formAjuste', route: '{{ route("inventario.ajuste") }}' }
    ];
