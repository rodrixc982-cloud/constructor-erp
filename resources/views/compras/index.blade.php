...
{{-- Modal Generar desde Presupuesto --}}
                ...
                <div class="mb-3">
                    ...
                    <select id="genPresupuestoId" class="form-select">
                        ...
                        @foreach($presupuestos as $p)
                            <option value="{{ $p->id }}">{{ $p->codigo }} - {{ $p->cliente?->nombre ?? 'Sin cliente' }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="fecha" id="orden_fecha" class="form-control" value="{{ now()->format('Y-m-d') }}" required>
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    $('#btnNuevoOrden').on('click', function() {
        $('#formOrden')[0].reset();
        $('#orden_fecha').val('{{ now()->format("Y-m-d") }}');
