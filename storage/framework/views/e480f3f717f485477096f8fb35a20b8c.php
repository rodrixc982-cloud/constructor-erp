<?php $__env->startSection('titulo', 'Auditoría'); ?>
        ...
        <div class="row align-items-end">
            <div class="col-md-3 mb-2 mb-md-0">
                ...
                <select id="filtroLogName" class="form-select">
                    ...
                    <?php $__currentLoopData = $logNames; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ln): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($ln); ?>"><?php echo e(ucfirst($ln)); ?></option>
...
$(document).ready(function() {
    ...
    function construirUrl() {
        ...
        return '<?php echo e(route("auditoria.datos")); ?>?' + params.toString();
    }
    ...
    $('#btnLimpiarLog').on('click', function() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '<?php echo e(route("auditoria.limpiar")); ?>',
                    type: 'DELETE',
                    headers: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\constructor-erp\resources\views/auditoria/index.blade.php ENDPATH**/ ?>