<?php $__env->startSection('titulo', 'Presupuesto '.$presupuesto->codigo); ?>
<?php $__env->startPush('estilos'); ?><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/select2/4.1.0-rc.0/css/select2.min.css"><?php $__env->stopPush(); ?>
<?php $__env->startSection('breadcrumbs'); ?><li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>">Dashboard</a></li><li class="breadcrumb-item"><a href="<?php echo e(route('presupuestos.index')); ?>">Presupuestos</a></li><li class="breadcrumb-item active"><?php echo e($presupuesto->codigo); ?></li><?php $__env->stopSection(); ?>

<?php $__env->startSection('contenido'); ?>
<div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-3">
    <div>
        <h4 class="mb-0"><?php echo e($presupuesto->codigo); ?> <span class="badge bg-secondary" id="badgeVersion">v<?php echo e($presupuesto->version); ?></span> <span class="badge" id="badgeEstado"><?php echo e($presupuesto->estado); ?></span></h4>
        <small class="text-muted"><?php echo e($presupuesto->cliente?->nombre ?? 'Sin cliente'); ?> — <?php echo e($presupuesto->obra?->nombre ?? 'Sin obra'); ?></small>
    </div>
    <div class="d-flex gap-2 flex-wrap">
        ...
        <a href="/presupuestos/<?php echo e($presupuesto->id); ?>/exportar/pdf" class="btn btn-danger btn-sm"><i class="fas fa-file-pdf me-1"></i>Exportar PDF</a>
    </div>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="formCabecera">
                    <div class="mb-2"><label class="form-label small">IGV %</label><input type="number" step="0.01" name="igv" class="form-control form-control-sm" value="<?php echo e($presupuesto->igv); ?>"></div>
                    <div class="mb-2"><label class="form-label small">Descuento %</label><input type="number" step="0.01" name="descuento_pct" class="form-control form-control-sm" value="<?php echo e($presupuesto->descuento_pct); ?>"></div>
                    <input type="hidden" name="fecha" value="<?php echo e($presupuesto->fecha->format('Y-m-d')); ?>">
                    <input type="hidden" name="validez_dias" value="<?php echo e($presupuesto->validez_dias); ?>">
                    <input type="hidden" name="moneda" value="<?php echo e($presupuesto->moneda); ?>">
        ...
        <div class="modal-body">
            <div class="mb-3"><label class="form-label">APU *</label>
                <select name="apu_id" class="form-select select2" required>
                    <?php $__currentLoopData = $apus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($a->id); ?>"><?php echo e($a->codigo); ?> — <?php echo e($a->descripcion); ?> (<?php echo e($a->unidad); ?>)</option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
        ...
        <div class="modal-body">
            <div class="mb-3"><label class="form-label">Tipo *</label>
                <select name="tipo" class="form-select" required>
                    <?php $__currentLoopData = ['transporte'=>'Transporte','hospedaje'=>'Hospedaje','viaticos'=>'Viáticos','seguro'=>'Seguro','herramienta'=>'Herramienta','otro'=>'Otro']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v=>$l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($v); ?>"><?php echo e($l); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
...
const presupuestoId = <?php echo e($presupuesto->id); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\constructor-erp\resources\views/presupuestos/edit.blade.php ENDPATH**/ ?>