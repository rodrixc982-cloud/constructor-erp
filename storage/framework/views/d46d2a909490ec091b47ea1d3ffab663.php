<?php $__env->startSection('titulo', 'Caja'); ?>
...
<div class="row g-3 mb-3">
    <div class="col-md-4">
        <div class="small-box bg-info">
            <div class="inner">
                <h3>S/ <?php echo e(number_format($saldo, 2)); ?></h3>
                <p>Saldo actual</p>
            </div>
    ...
    <div class="col-md-4">
        <div class="small-box bg-success">
            <div class="inner">
                <h3>S/ <?php echo e(number_format($ingresosMes, 2)); ?></h3>
    ...
    <div class="col-md-4">
        <div class="small-box bg-danger">
            <div class="inner">
                <h3>S/ <?php echo e(number_format($egresosMes, 2)); ?></h3>
                <p>Egresos del mes</p>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="date" name="fecha" id="ingreso_fecha" class="form-control" value="<?php echo e(now()->format('Y-m-d')); ?>" required>
                        </div>
                    </div>
                    <div class="mb-3">
            ...
            <form id="formEgreso">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            <label class="form-label">Fecha *</label>
                            <input type="date" name="fecha" id="egreso_fecha" class="form-control" value="<?php echo e(now()->format('Y-m-d')); ?>" required>
                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Cliente</label>
...
$(document).ready(function() {
    ...
    var tabla = $('#tablaCaja').DataTable({
        ...
        serverSide: false,
        ajax: {
            url: '<?php echo e(route("caja.datos")); ?>',
            type: 'GET',
    ...
    $('#btnNuevoIngreso').on('click', function() {
        $('#formIngreso')[0].reset();
        $('#ingreso_fecha').val('<?php echo e(now()->format("Y-m-d")); ?>');
    ...
    $('#btnNuevoEgreso').on('click', function() {
        $('#formEgreso')[0].reset();
        $('#egreso_fecha').val('<?php echo e(now()->format("Y-m-d")); ?>');
    ...
    function guardarMovimiento(tipo, modalId, btnId) {
        ...
        $.ajax({
            url: '<?php echo e(route("caja.store")); ?>',
            type: 'POST',
            headers: {
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\constructor-erp\resources\views/caja/index.blade.php ENDPATH**/ ?>