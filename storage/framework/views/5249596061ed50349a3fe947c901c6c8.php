...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('equipos.crear')): ?>
...
$(document).ready(function() {
    ...
    var tabla = $('#tablaEquipos').DataTable({
        ...
        serverSide: false,
        ajax: {
            url: '<?php echo e(route("equipos.datos")); ?>',
            type: 'GET',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\constructor-erp\resources\views/equipos/index.blade.php ENDPATH**/ ?>