<?php $__env->startSection('titulo', 'Obras'); ?>
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('obras.crear')): ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select name="estado" id="obra_estado" class="form-select" required>
                                <?php $__currentLoopData = ['planificacion'=>'Planificación','activa'=>'Activa','pausada'=>'Pausada','terminada'=>'Terminada','cancelada'=>'Cancelada']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v=>$l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
$(document).ready(function() {
    ...
    var tabla = $('#tablaObras').DataTable({
        ...
        serverSide: false,
        ajax: {
            url: '<?php echo e(route("obras.datos")); ?>',
            type: 'GET',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\constructor-erp\resources\views/obras/index.blade.php ENDPATH**/ ?>