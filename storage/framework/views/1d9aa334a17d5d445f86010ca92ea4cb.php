...
<div class="row g-3">
    <div class="col-lg-3 col-6">
        <div class="small-box bg-info">
            <div class="inner">
                <h3><?php echo e($stats['obras_activas'] ?? 0); ?></h3>
                <p>Obras activas</p>
            ...
            <a href="<?php echo e(route('obras.index')); ?>" class="small-box-footer">
    ...
    <div class="col-lg-3 col-6">
        <div class="small-box bg-success">
            <div class="inner">
                <h3><?php echo e($stats['obras_terminadas'] ?? 0); ?></h3>
    ...
    <div class="col-lg-3 col-6">
        <div class="small-box bg-warning">
            <div class="inner">
                <h3><?php echo e($stats['clientes'] ?? 0); ?></h3>
                <p>Clientes</p>
                <span class="stat-badge">
    ...
    <div class="col-lg-3 col-6">
        <div class="small-box bg-danger">
            <div class="inner">
                <h3><?php echo e($stats['presupuestos'] ?? 0); ?></h3>
                <p>Presupuestos</p>
                <span class="stat-badge">
            ...
            <a href="<?php echo e(route('presupuestos.index')); ?>" class="small-box-footer">
                Ver todos <i class="fas fa-arrow-circle-right ms-1"></i>
            </a>
        </div>
    </div>
            ...
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    <span class="badge bg-success me-1">
                        +<?php echo e(number_format($stats['utilidad_mes'] ?? 0, 2)); ?>

                    </span>
                    <span class="badge bg-secondary"><?php echo e(now()->year); ?></span>
                </div>
            </div>
            <div class="card-body">
        ...
        <div class="card summary-card">
            ...
            <div class="card-body">
                <div class="summary-item">
                    ...
                    <span class="value positive">S/ <?php echo e(number_format($stats['ganancias_mes'] ?? 0, 2)); ?></span>
                </div>
                <div class="summary-item">
                    <span class="label"><i class="fas fa-arrow-down text-danger me-2"></i>Gastos</span>
                    <span class="value negative">S/ <?php echo e(number_format($stats['gastos_mes'] ?? 0, 2)); ?></span>
                </div>
                <div class="summary-item" style="border-bottom: 2px solid #e9ecef; padding-bottom: 16px;">
                    ...
                    <span class="value" style="font-size: 1.2rem; color: #28a745;">
                        S/ <?php echo e(number_format($stats['utilidad_mes'] ?? 0, 2)); ?>
                ...
                <div class="mt-3">
                    <div class="d-flex justify-content-between mb-1">
                        ...
                        <small class="fw-bold"><?php echo e($stats['presupuestos_aprobados'] ?? 0); ?></small>
                    </div>
                    <div class="progress mb-2" style="height: 6px; border-radius: 4px;">
                        <div class="progress-bar bg-success" style="width: <?php echo e(min(100, (($stats['presupuestos_aprobados'] ?? 0) / max(1, $stats['presupuestos'] ?? 1)) * 100)); ?>%; border-radius: 4px;"></div>
                    </div>
                    <div class="d-flex justify-content-between mb-1">
                        <small class="text-muted">Obras activas</small>
                        <small class="fw-bold text-primary"><?php echo e($stats['obras_activas'] ?? 0); ?></small>
                    </div>
                    <div class="progress mb-2" style="height: 6px; border-radius: 4px;">
                        <div class="progress-bar bg-primary" style="width: <?php echo e(min(100, (($stats['obras_activas'] ?? 0) / max(1, ($stats['obras_activas'] ?? 0) + ($stats['obras_terminadas'] ?? 0))) * 100)); ?>%; border-radius: 4px;"></div>
                    </div>
                    <div class="d-flex justify-content-between">
                        <small class="text-muted">Proveedores activos</small>
                        <small class="fw-bold text-info"><?php echo e($stats['proveedores'] ?? 0); ?></small>
                    </div>
                </div>
                <hr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\constructor-erp\resources\views/dashboard/index.blade.php ENDPATH**/ ?>