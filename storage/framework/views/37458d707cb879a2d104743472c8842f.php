<?php $__env->startSection('titulo', 'Facturación'); ?>
...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('facturacion.crear')): ?>
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <select name="tipo" id="doc_tipo" class="form-select" required>
                            <?php $__currentLoopData = ['cotizacion'=>'Cotización','proforma'=>'Proforma','factura'=>'Factura','boleta'=>'Boleta','orden_servicio'=>'Orden de Servicio']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v=>$l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="date" name="fecha" id="doc_fecha" class="form-control" value="<?php echo e(now()->format('Y-m-d')); ?>" required>
                        </div>
                    </div>
...
$(document).ready(function() {
    ...
    $('#btnNuevoDocumento').on('click', function() {
        ...
        $('#doc_fecha').val('<?php echo e(now()->format("Y-m-d")); ?>');
    ...
    $('#formDocumento').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo e(route("facturacion.store")); ?>',
            type: 'POST',
            headers: {
                'X-CSRF-TOKEN': csrfToken,
                'Accept': 'application/json'
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\constructor-erp\resources\views/facturacion/index.blade.php ENDPATH**/ ?>